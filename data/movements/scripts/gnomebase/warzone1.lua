...
if item.actionid == 5157 then
	PlayerSendTextMessage(cid, 19, "You have half an hour to heroically defeat Deathstrike. Otherwise you'll be teleported out by the gnomish emergency device.")
	deDeathstrike()
