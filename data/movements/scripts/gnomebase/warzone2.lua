...
if(getGlobalStorageValue(99159) < 1) then
	...
	PlayerSendTextMessage(cid, 19, "You have half an hour to heroically defeat Gnomevil. Otherwise you'll be teleported out by the gnomish emergency device.")
	deGnomevil()
	deSummonGnomevil()
...
elseif item.actionid == 5160 then
		...
		--else 
		--PlayerSendTextMessage(cid, 19, "The boss has already been killed today, the spawn takes place from 10 to 10 hours.")
