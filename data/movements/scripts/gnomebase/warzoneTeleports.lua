local teleGnome = {
	...
	{posCrystal = {x=32795,y=31761,z=10}, posGo = {x=33000,y=31870,z=13}, needItem = false, idItem = 18457}, -- do crystal de gnome base para crystal ground
	{posCrystal = {x=33000,y=31871,z=13}, posGo = {x=32795,y=31762,z=10}, needItem = false, idItem = 18457}, -- do crystal de crystal ground para gnome base
	{posCrystal = {x=32803,y=31745,z=10}, posGo = {x=32864,y=31844,z=11}, needItem = false, idItem = 18457}, -- do crystal de gnome base para truffels garden
	{posCrystal = {x=32864,y=31845,z=11}, posGo = {x=32803,y=31746,z=10}, needItem = false, idItem = 18457}, -- do crystal de truffels garden para gnome base
	...
	{posCrystal = {x=33003,y=31918,z=10}, posGo = {x=33008,y=31922,z=10}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 1 DENTRO para WARZONE 1 FORA
	{posCrystal = {x=33007,y=31921,z=10}, posGo = {x=33002,y=31918,z=10}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 1 FORA para WARZONE 1 DENTRO
	...
	{posCrystal = {x=33011,y=31936,z=11}, posGo = {x=33014,y=31934,z=11}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 2 DENTRO para WARZONE 2 FORA
	{posCrystal = {x=33013,y=31934,z=11}, posGo = {x=33010,y=31937,z=11}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 2 FORA para WARZONE 2 DENTRO
	...
	{posCrystal = {x=32993,y=31913,z=12}, posGo = {x=32996,y=31917,z=12}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 3 DENTRO para WARZONE 3 FORA
	{posCrystal = {x=32995,y=31916,z=12}, posGo = {x=32992,y=31912,z=12}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 3 FORA para WARZONE 3 DENTRO
	...
	{posCrystal = {x=33104,y=31909,z=10}, posGo = {x=33103,y=31959,z=10}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 1 FORA BOSS para WARZONE 1 DENTRO BOSS
	...
	{posCrystal = {x=33097,y=31977,z=11}, posGo = {x=33110,y=31949,z=11}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 2 FORA BOSS para WARZONE 2 DENTRO BOSS
	...
	{posCrystal = {x=33073,y=31880,z=12}, posGo = {x=33083,y=31905,z=12}, needItem = false, idItem = 18457}, -- do crystal de WARZONE 3 FORA BOSS para WARZONE 3 DENTRO BOSS
	...
	for i=1, #teleGnome do
		if teleGnome[i].posCrystal.x == posPlayer.x and teleGnome[i].posCrystal.y == posPlayer.y and teleGnome[i].posCrystal.z == posPlayer.z then
			if teleGnome[i].needItem then
				if PlayerRemoveItem(cid, teleGnome[i].idItem, 1) then
					doTeleportThing(cid, teleGnome[i].posGo)
					doSendMagicEffect(teleGnome[i].posGo, 10)
				else		
					doTeleportThing(cid, fromPosition, true)	
					PlayerSendCancel(cid, "You don't have one teleport crystal.")
				end
			else
				doTeleportThing(cid, teleGnome[i].posGo)
				doSendMagicEffect(teleGnome[i].posGo, 10)
