...
PlayerSendTextMessage(cid,19,"A strange ritual has taken place here. Report about it to the Gloot Brothers.")
--player:sendTextMessage(MESSAGE_EVENT_ADVANCE, 'A strange ritual has taken place here. Report about it to the Gloot Brothers.')
PlayerSetStorageValue(cid, 20054, 1)
PlayerSetStorageValue(cid, 20055, 0)

elseif getPlayerStorageValue(cid, 10050) >= 6 then 
doTeleportThing(cid, fromPosition, true)
doTeleportThing(cid, {x = 33419, y = 32106, z = 10})

PlayerSendTextMessage(cid,19,"The necrometer reveals a hidden passage!")
