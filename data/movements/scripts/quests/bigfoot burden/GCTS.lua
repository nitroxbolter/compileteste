local destination = {
	...
	[3215] = {position = Position(32331, 32173, 9), storageValue = 1, needCrystal = true},
	[3216] = {position = Position(32197, 31183, 8), storageValue = 1, needCrystal = true},
	[3217] = {position = Position(32403, 32817, 6), storageValue = 1, needCrystal = true},
	[3218] = {position = Position(33186, 32384, 8), storageValue = 1, needCrystal = true},
	[3219] = {position = Position(33153, 31834, 10), storageValue = 1, needCrystal = true}
}
