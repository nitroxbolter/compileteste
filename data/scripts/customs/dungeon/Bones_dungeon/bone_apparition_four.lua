local config = {
    ...
    bosses = {
        { name = "bone berserker", pos = Position(31692, 32268, 8) },
        { name = "bone archer", pos = Position(31691, 32271, 8) },
        { name = "bone mage", pos = Position(31703, 32277, 8) },
        { name = "bone slicer", pos = Position(31697, 32276, 8) },
        { name = "bone master", pos = Position(31704, 32278, 8) }
    }
}
