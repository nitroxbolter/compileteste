local config = {
    ...
    bosses = {
        { name = "bone berserker", pos = Position(31698, 32213, 8) },
        { name = "bone archer", pos = Position(31697, 32223, 8) },
        { name = "bone mage", pos = Position(31700, 32224, 8) },
        { name = "bone slicer", pos = Position(31701, 32225, 8) },
        { name = "bone master", pos = Position(31693, 32213, 8) }
    }
}
