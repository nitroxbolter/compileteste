local config = {
    ...
    bossPosition = Position(32049, 33151, 10), 
    bossArea = {
        fromPos = Position(32038, 33139, 10), 
        toPos = Position(32061, 33161, 10), 
        entrancePos = Position(32043, 33151, 10), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31974, 33149, 10),
        Position(31974, 33150, 10),
        Position(31974, 33151, 10), 
        Position(31974, 33152, 10) 
    },
    attempts = {
        level = 500, 
        storage = 720007, 
    ...
    createTeleportPos = Position(32047, 33143, 10), 
