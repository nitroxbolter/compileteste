local config = {
    ...
    bossPosition = Position(31701, 31569, 12), 
    bossArea = {
        fromPos = Position(31665, 31542, 12), 
        toPos = Position(31725, 31590, 12), 
        entrancePos = Position(31690, 31553, 12), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31683, 31555, 11),
        Position(31683, 31556, 11),
        Position(31683, 31557, 11), 
        Position(31683, 31558, 11) 
    },
    attempts = {
        level = 500, 
        storage = 720010, 
    ...
    createTeleportPos = Position(31685, 31549, 12),  
