local config = {
    actionId = 43022, 
    bossName = "Bakragore",
    bossPosition = Position(34421, 31305, 9), 
    bossArea = {
        fromPos = Position(34406, 31293, 9), 
        toPos = Position(34432, 31314, 9), 
        entrancePos = Position(34410, 31304, 9), 
        exitPosition = Position(34365, 31289, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34364, 31291, 9),
        Position(34365, 31291, 9),
        Position(34366, 31291, 9), 
        Position(34367, 31291, 9)
    },
    attempts = {
        level = 100, 
        storage = 710091, 
    ...
    createTeleportPos = Position(34423, 31301, 9), 
    teleportToPosition = Position(34365, 31289, 9), 
