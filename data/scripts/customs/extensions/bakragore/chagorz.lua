local config = {
    actionId = 43016, 
    bossName = "Chagorz",
    bossPosition = Position(34025, 31219, 10), 
    bossArea = {
        fromPos = Position(34018, 31195, 10), 
        toPos = Position(34053, 31237, 10), 
        entrancePos = Position(34026, 31200, 10), 
        exitPosition = Position(34021, 31193, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34021, 31197, 11),
        Position(34020, 31196, 11),
        Position(34022, 31196, 11), 
        Position(34021, 31195, 11)
    },
    attempts = {
        level = 100, 
        storage = 710042, 
    ...
    createTeleportPos = Position(34026, 31223, 10), 
    teleportToPosition = Position(34021, 31193, 11), 
