local config = {
    actionId = 43020, 
    bossName = "Ichgahal",
    bossPosition = Position(34402, 31293, 12), 
    bossArea = {
        fromPos = Position(34392, 31284, 12), 
        toPos = Position(34413, 31302, 12), 
        entrancePos = Position(34395, 31293, 12), 
        exitPosition = Position(34355, 31285, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34354, 31288, 12),
        Position(34355, 31288, 12),
        Position(34356, 31288, 12), 
        Position(34357, 31288, 12)
    },
    attempts = {
        level = 100, 
        storage = 710043, 
    ...
    createTeleportPos = Position(34400, 31287, 12), 
    teleportToPosition = Position(34355, 31285, 12), 
