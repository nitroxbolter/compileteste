local config = {
    actionId = 43018, 
    bossName = "Murcion",
    bossPosition = Position(34417, 31257, 11), 
    bossArea = {
        fromPos = Position(34394, 31233, 11), 
        toPos = Position(34438, 31280, 11), 
        entrancePos = Position(34417, 31239, 11), 
        exitPosition = Position(34540, 31185, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34540, 31183, 11),
        Position(34540, 31184, 11),
        Position(34540, 31185, 11), 
        Position(34540, 31186, 11)
    },
    attempts = {
        level = 100, 
        storage = 710044, 
    ...
    createTeleportPos = Position(34414, 31255, 11), 
    teleportToPosition = Position(34540, 31185, 11), 
