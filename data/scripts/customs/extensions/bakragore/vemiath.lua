local config = {
    actionId = 43019, 
    bossName = "Vemiath",
    bossPosition = Position(34301, 31051, 14), 
    bossArea = {
        fromPos = Position(34291, 31044, 14), 
        toPos = Position(34310, 31060, 14), 
        entrancePos = Position(34296, 31051, 14), 
        exitPosition = Position(34301, 31070, 14) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34300, 31072, 14),
        Position(34301, 31072, 14),
        Position(34302, 31072, 14), 
        Position(34303, 31072, 14)
    },
    attempts = {
        level = 100, 
        storage = 710051, 
    ...
    createTeleportPos = Position(34301, 31046, 14), 
    teleportToPosition = Position(34301, 31070, 14), 
