local config = {
    ...
    bossPosition = Position(33390, 31334, 9), 
    bossArea = {
        fromPos = Position(33378, 31327, 9), 
        toPos = Position(33400, 31347, 9), 
        entrancePos = Position(33390, 31342, 9), 
        exitPosition = Position(33390, 31360, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33390, 31363, 9),
        Position(33389, 31363, 9),
        Position(33388, 31363, 9), 
        Position(33391, 31363, 9),
        Position(33392, 31363, 9)
    },
    attempts = {
        level = 200, 
        storage = 720018, 
    ...
    createTeleportPos = Position(33389, 31333, 9), 
    teleportToPosition = Position(33390, 31360, 9), 
