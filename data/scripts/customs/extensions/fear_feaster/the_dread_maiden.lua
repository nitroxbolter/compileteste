local config = {
    ...
    bossPosition = Position(34110, 31213, 9), 
    bossArea = {
        fromPos = Position(34098, 31202, 9), 
        toPos = Position(34124, 31226, 9), 
        entrancePos = Position(34118, 31214, 9), 
        exitPosition = Position(34139, 31214, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34137, 31216, 9),
        Position(34138, 31216, 9),
        Position(34139, 31216, 9), 
        Position(34140, 31216, 9),
        Position(34141, 31216, 9)
    },
    attempts = {
        level = 200, 
        storage = 720019, 
    ...
    createTeleportPos = Position(34110, 31206, 9), 
    teleportToPosition = Position(34139, 31214, 9), 
