local config = {
    ...
    bossPosition = Position(34175, 31163, 9), 
    bossArea = {
        fromPos = Position(34166, 31155, 9), 
        toPos = Position(34183, 31174, 9), 
        entrancePos = Position(34175, 31168, 9), 
        exitPosition = Position(34200, 31162, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34198, 31165, 9),
        Position(34199, 31165, 9),
        Position(34200, 31165, 9), 
        Position(34201, 31165, 9),
        Position(34202, 31165, 9)
    },
    attempts = {
        level = 200, 
        storage = 720023, 
    ...
    createTeleportPos = Position(34175, 31157, 9), 
    teleportToPosition = Position(34200, 31162, 9), 
