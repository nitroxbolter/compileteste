local config = {
    ...
    bossPosition = Position(34204, 31215, 9), 
    bossArea = {
        fromPos = Position(34191, 31203, 9), 
        toPos = Position(34218, 31227, 9), 
        entrancePos = Position(34193, 31214, 9), 
        exitPosition = Position(34173, 31211, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34170, 31214, 9),
        Position(34171, 31214, 9),
        Position(34172, 31214, 9), 
        Position(34173, 31214, 9),
        Position(34174, 31214, 9), 
    },
    attempts = {
        level = 200, 
        storage = 720021, 
    ...
    createTeleportPos = Position(34203, 31207, 9), 
    teleportToPosition = Position(34173, 31211, 9), 
