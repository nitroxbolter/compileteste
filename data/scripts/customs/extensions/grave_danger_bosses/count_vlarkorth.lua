local config = {
    ...
    bossPosition = Position(31950, 32362, 8), 
    bossArea = {
        fromPos = Position(31939, 32350, 8), 
        toPos = Position(31963, 32373, 8), 
        entrancePos = Position(31942, 32362, 8), 
        exitPosition = Position(31950, 32333, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31949, 32337, 8),
        Position(31950, 32337, 8),
        Position(31951, 32337, 8), 
        Position(31952, 32337, 8),
        Position(31953, 32337, 8)
    },
    attempts = {
        level = 100, 
        storage = 720025, 
    ...
    createTeleportPos = Position(31950, 32353, 8), 
    teleportToPosition = Position(31950, 32333, 8), 
