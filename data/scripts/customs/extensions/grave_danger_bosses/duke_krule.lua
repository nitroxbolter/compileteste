local config = {
    actionId = 42585, 
    bossName = "duke krule",
    bossPosition = Position(31951, 32396, 8), 
    bossArea = {
        fromPos = Position(31939, 32384, 8), 
        toPos = Position(31963, 32408, 8), 
        entrancePos = Position(31942, 32396, 8), 
        exitPosition = Position(31951, 32421, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31949, 32417, 8),
        Position(31950, 32417, 8),
        Position(31951, 32417, 8), 
        Position(31952, 32417, 8),
        Position(31953, 32417, 8)
    },
    attempts = {
        level = 100, 
        storage = 720026, 
    ...
    createTeleportPos = Position(31950, 32388, 8), 
    teleportToPosition = Position(31951, 32421, 8), 
