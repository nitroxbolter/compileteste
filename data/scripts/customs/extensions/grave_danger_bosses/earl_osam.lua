local config = {
    actionId = 42582, 
    bossName = "earl osam",
    bossPosition = Position(31982, 32362, 8), 
    bossArea = {
        fromPos = Position(31970, 32350, 8), 
        toPos = Position(31996, 32374, 8), 
        entrancePos = Position(31974, 32362, 8), 
        exitPosition = Position(32011, 32363, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32010, 32368, 8),
        Position(32011, 32368, 8),
        Position(32012, 32368, 8), 
        Position(32013, 32368, 8),
        Position(32014, 32368, 8)
    },
    attempts = { 
        level = 100, 
        storage = 720027, 
    ...
    createTeleportPos = Position(31982, 32354, 8), 
    teleportToPosition = Position(32011, 32363, 8), 
