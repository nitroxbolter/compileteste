local config = {
    ...
    bossPosition = Position(31918, 32395, 8), 
    bossArea = {
        fromPos = Position(31905, 32384, 8), 
        toPos = Position(31930, 32409, 8), 
        entrancePos = Position(31910, 32396, 8), 
        exitPosition = Position(31917, 32420, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31916, 32417, 8),
        Position(31917, 32417, 8),
        Position(31918, 32417, 8), 
        Position(31919, 32417, 8),
        Position(31920, 32417, 8)
    },
    attempts = {
        level = 100, 
        storage = 720841, 
    ...
    createTeleportPos = Position(31918, 32388, 8), 
    teleportToPosition = Position(31917, 32420, 8), 
