local config = {
    actionId = 42583, 
    bossName = "sir baeloc",
    bossPosition = Position(31918, 32362, 8), 
    bossArea = {
        fromPos = Position(31904, 32353, 8), 
        toPos = Position(31930, 32374, 8), 
        entrancePos = Position(31910, 32363, 8), 
        exitPosition = Position(31920, 32333, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31918, 32337, 8),
        Position(31919, 32337, 8),
        Position(31920, 32337, 8), 
        Position(31921, 32337, 8),
        Position(31922, 32337, 8)
    },
    attempts = {
        level = 100, 
        storage = 720130, 
    ...
    createTeleportPos = Position(31919, 32355, 8), 
    teleportToPosition = Position(31920, 32333, 8), 
