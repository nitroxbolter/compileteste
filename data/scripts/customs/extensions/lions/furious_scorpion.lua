local config = {
    ...
    bossPosition = Position(33857, 31172, 8), 
    bossArea = {
        fromPos = Position(33854, 31164, 8), 
        toPos = Position(33872, 31178, 8), 
        entrancePos = Position(33871, 31172, 8), 
        exitPosition = Position(33875, 31174, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33875, 31176, 8),
    },
    attempts = {
        level = 100, 
        storage = 720028, 
    ...
    createTeleportPos = Position(33856, 31172, 8), 
    teleportToPosition = Position(33875, 31174, 8), 
