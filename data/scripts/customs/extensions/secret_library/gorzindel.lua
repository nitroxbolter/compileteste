local config = {
    actionId = 27101, 
    bossName = "gorzindel",
    bossPosition = Position(31537, 31994, 9), 
    bossArea = {
        fromPos = Position(31525, 31983, 9), 
        toPos = Position(31548, 32009, 9), 
        entrancePos = Position(31536, 32001, 9), 
        exitPosition = Position(31529, 32019, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31528, 32022, 9),
        Position(31529, 32022, 9),
        Position(31530, 32022, 9), 
        Position(31531, 32022, 9),
        Position(31532, 32022, 9)
    },
    attempts = {
        level = 200, 
        storage = 720015, 
    ...
    createTeleportPos = Position(31537, 31986, 9), 
    teleportToPosition = Position(31529, 32019, 9), 
