local config = {
    actionId = 27102, 
    bossName = "ghulosh",
    bossPosition = Position(31532, 31958, 9), 
    bossArea = {
        fromPos = Position(31520, 31950, 9), 
        toPos = Position(31543, 31971, 9), 
        entrancePos = Position(31532, 31968, 9), 
        exitPosition = Position(31529, 32043, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31528, 32046, 9),
        Position(31529, 32046, 9),
        Position(31530, 32046, 9), 
        Position(31531, 32046, 9),
        Position(31532, 32046, 9)
    },
    attempts = {
        level = 200, 
        storage = 720214, 
    ...
    createTeleportPos = Position(31532, 31954, 9), 
    teleportToPosition = Position(31529, 32043, 9), 
