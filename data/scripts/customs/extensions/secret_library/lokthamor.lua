local config = {
    actionId = 27103, 
    bossName = "lokathmor",
    bossPosition = Position(31505, 31993, 9), 
    bossArea = {
        fromPos = Position(31494, 31982, 9), 
        toPos = Position(31517, 32004, 9), 
        entrancePos = Position(31505, 32000, 9), 
        exitPosition = Position(31503, 32019, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31502, 32022, 9),
        Position(31503, 32022, 9),
        Position(31504, 32022, 9), 
        Position(31505, 32022, 9),
        Position(31506, 32022, 9)
    },
    attempts = {
        level = 200, 
        storage = 720016, 
    ...
    createTeleportPos = Position(31505, 31986, 9), 
    teleportToPosition = Position(31503, 32019, 9), 
