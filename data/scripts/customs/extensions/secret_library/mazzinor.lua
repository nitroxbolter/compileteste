local config = {
    actionId = 27104, 
    bossName = "mazzinor",
    bossPosition = Position(31468, 31989, 9), 
    bossArea = {
        fromPos = Position(31456, 31979, 9), 
        toPos = Position(31482, 32005, 9), 
        entrancePos = Position(31468, 31998, 9), 
        exitPosition = Position(31503, 32043, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31502, 32046, 9),
        Position(31503, 32046, 9),
        Position(31504, 32046, 9), 
        Position(31505, 32046, 9),
        Position(31506, 32046, 9)
    },
    attempts = {
        level = 200, 
        storage = 720017, 
    ...
    createTeleportPos = Position(31468, 31985, 9), 
    teleportToPosition = Position(31503, 32043, 9), 
