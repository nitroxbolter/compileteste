local config = {
    ...
    bossPosition = Position(33978, 31349, 10), 
    bossArea = {
        fromPos = Position(33966, 31339, 10), 
        toPos = Position(33990, 31361, 10), 
        entrancePos = Position(33979, 31357, 10), 
        exitPosition = Position(33944, 31348, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33945, 31350, 10),
        Position(33946, 31350, 10),
        Position(33947, 31350, 10), 
        Position(33948, 31350, 10),
        Position(33949, 31350, 10)
    },
    attempts = {
        level = 200, 
        storage = 720044, 
    ...
    createTeleportPos = Position(33979, 31342, 10), 
    teleportToPosition = Position(33944, 31348, 10), 
