local config = {
    ...
    bossPosition = Position(33901, 31226, 7), 
    bossArea = {
        fromPos = Position(33891, 31216, 7), 
        toPos = Position(33912, 31235, 7), 
        entrancePos = Position(33901, 31233, 7), 
        exitPosition = Position(33903, 31226, 6) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33900, 31214, 6),
        Position(33901, 31214, 6),
        Position(33902, 31214, 6), 
        Position(33903, 31214, 6),
        Position(33904, 31214, 6)
    },
    attempts = {
        level = 200, 
        storage = 720043, 
    ...
    createTeleportPos = Position(33893, 31225, 7), 
    teleportToPosition = Position(33903, 31226, 6), 
