local config = {
    ...
    bossPosition = Position(34015, 31382, 10), 
    bossArea = {
        fromPos = Position(34003, 31373, 10), 
        toPos = Position(34028, 31393, 10), 
        entrancePos = Position(34016, 31389, 10), 
        exitPosition = Position(34046, 31378, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34045, 31381, 10),
        Position(34046, 31381, 10),
        Position(34047, 31381, 10), 
        Position(34048, 31381, 10),
        Position(34049, 31381, 10)
    },
    attempts = {
        level = 200, 
        storage = 720045, 
    ...
    createTeleportPos = Position(34015, 31376, 10), 
    teleportToPosition = Position(34046, 31378, 10), 
