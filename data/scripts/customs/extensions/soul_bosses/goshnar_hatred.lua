local config = {
    ...
    bossPosition = Position(34012, 31315, 10), 
    bossArea = {
        fromPos = Position(34000, 31306, 10), 
        toPos = Position(34024, 31325, 10), 
        entrancePos = Position(34012, 31321, 10), 
        exitPosition = Position(34043, 31315, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34042, 31317, 10),
        Position(34043, 31317, 10),
        Position(34044, 31317, 10), 
        Position(34045, 31317, 10),
        Position(34046, 31317, 10)
    },
    attempts = {
        level = 200, 
        storage = 720041, 
    ...
    createTeleportPos = Position(34012, 31310, 10), 
    teleportToPosition = Position(34043, 31315, 10), 
