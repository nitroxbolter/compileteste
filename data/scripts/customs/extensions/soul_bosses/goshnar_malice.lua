local config = {
    ...
    bossPosition = Position(33978, 31314, 10), 
    bossArea = {
        fromPos = Position(33968, 31304, 10), 
        toPos = Position(33989, 31326, 10), 
        entrancePos = Position(33969, 31314, 10), 
        exitPosition = Position(33949, 31313, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33948, 31315, 10),
        Position(33949, 31315, 10),
        Position(33950, 31315, 10), 
        Position(33951, 31315, 10),
        Position(33952, 31315, 10)
    },
    attempts = {
        level = 200, 
        storage = 720040, 
    ...
    createTeleportPos = Position(33977, 31307, 10), 
    teleportToPosition = Position(33949, 31313, 10), 
