local config = {
    ...
    bossPosition = Position(34011, 31348, 10), 
    bossArea = {
        fromPos = Position(34000, 31338, 10), 
        toPos = Position(34023, 31359, 10), 
        entrancePos = Position(34011, 31355, 10), 
        exitPosition = Position(34044, 31348, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(34043, 31350, 10),
        Position(34044, 31350, 10),
        Position(34045, 31350, 10), 
        Position(34046, 31350, 10),
        Position(34047, 31350, 10)
    },
    attempts = {
        level = 200, 
        storage = 720042, 
    ...
    createTeleportPos = Position(34011, 31341, 10), 
    teleportToPosition = Position(34044, 31348, 10), 
