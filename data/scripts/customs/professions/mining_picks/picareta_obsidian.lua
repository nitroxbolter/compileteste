...
local config = {
    [29869] = {text = {"rock is regenerating"}}, 
    [29860] = {break_chance = 75, loot_chance = 80, lower_tier = 29869, requiredSkill = 0, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 29868, count = 4},-- carv√£o
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 29868, count = 8}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 29868, count = 10},
        },
    },
    [26418] = {text = {"Carv„o Vein is regenerating"}}, 
    [26405] = {break_chance = 75, loot_chance = 80, lower_tier = 26418, requiredSkill = 0, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26398, count = 6},-- carv„o
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26398, count = 7}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26423, count = 2}, -- pedra de carvao
        },
    },
    [26419] = {text = {"Estanho Vein is regenerating"}}, 
    [26406] = {break_chance = 75, loot_chance = 70, lower_tier = 26419, requiredSkill = 5, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26399, count = 6}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26399, count = 7}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26434, count = 2},-- pedra de estanho
        },
    },
    [26420] = {text = {"Cobre Vein is regenerating"}}, 
    [26407] = {break_chance = 75, loot_chance = 80, lower_tier = 26420, requiredSkill = 10, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26400, count = 6}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26400, count = 7}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26435, count = 2},-- pedra de cobre
        },
    },
    [26421] = {text = {"Ferro Vein is regenerating"}}, 
    [26408] = {break_chance = 75, loot_chance = 70, lower_tier = 26421, requiredSkill = 15, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26401, count = 5}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26401, count = 6}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26436, count = 2},-- pedra de ferro
        },
    },
    [26422] = {text = {"Ouro Vein is regenerating"}}, 
    [26409] = {break_chance = 75, loot_chance = 70, lower_tier = 26422, requiredSkill = 25, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26402, count = 3}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26402, count = 4}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26437, count = 1},-- pedra de ouro
        },
    },
    [26412] = {text = {"Obsidian Vein is regenerating"}}, 
    [26410] = {break_chance = 75, loot_chance = 70, lower_tier = 26412, requiredSkill = 30, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26403, count = 2}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26403, count = 3}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26403, count = 4},
        },
    },
    [29862] = {text = {"Diamante Vein is regenerating"}}, 
    [26411] = {break_chance = 75, loot_chance = 70, lower_tier = 29862, requiredSkill = 30, 
        normal_loot_table = { -- 80%
        ...
        rare_loot_table = { -- 5%
            [1] = {item_id = 26433, count = 1},-- Diamante grande
        },
    },
