local config = {
    ...
    bossPosition = Position(31278, 32908, 12), 
    bossArea = {
        fromPos = Position(31268, 32903, 12), 
        toPos = Position(31287, 32929, 12), 
        entrancePos = Position(31278, 32923, 12), 
        exitPosition = Position(31245, 32935, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31245, 32938, 11),
        Position(31245, 32939, 11),
        Position(31245, 32940, 11),
        Position(31245, 32941, 11),
    },
    attempts = {
        level = 200, 
        storage = 720072, 
    ...
    createTeleportPos = Position(31277, 32905, 12), 
    teleportToPosition = Position(31245, 32931, 11), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("arodisBossDeath")
...
local creatureEvent = CreatureEvent("arodisBossDeath")
