local config = {
    ...
    bossPosition = Position(31703, 32664, 11), 
    bossArea = {
        fromPos = Position(31697, 32657, 11), 
        toPos = Position(31713, 32671, 11), 
        entrancePos = Position(31711, 32664, 11), 
        exitPosition = Position(31726, 32664, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31717, 32663, 11),
        Position(31717, 32664, 11),
        Position(31717, 32665, 11), 
        Position(31717, 32666, 11), 
    },
    attempts = {
        level = 200, 
        storage = 720036, 
    ...
    createTeleportPos = Position(31701, 32664, 11), 
    teleportToPosition = Position(31720, 32645, 11), 
