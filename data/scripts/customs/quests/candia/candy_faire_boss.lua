local config = {
    ...
    bossPosition = Position(31738, 32523, 8), 
    bossArea = {
        fromPos = Position(31728, 32508, 8), 
        toPos = Position(31749, 32531, 8), 
        entrancePos = Position(31738, 32511, 8), 
        exitPosition = Position(31775, 32535, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31773, 32534, 8),
        Position(31773, 32535, 8),
        Position(31773, 32536, 8),
        Position(31773, 32537, 8),
    },
    attempts = {
        level = 200, 
        storage = 720076, 
    ...
    createTeleportPos = Position(31737, 32524, 8), 
    teleportToPosition = Position(31737, 32526, 8), 
