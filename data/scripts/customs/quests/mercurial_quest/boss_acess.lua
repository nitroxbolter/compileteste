local config = {
    ...
    bossPosition = Position(31246, 32525, 12), 
    bossArea = {
        fromPos = Position(31240, 32523, 12), 
        toPos = Position(31253, 32551, 12), 
        entrancePos = Position(31246, 32546, 12), 
        exitPosition = Position(31221, 32534, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31221, 32533, 12),
        Position(31220, 32534, 12),
        Position(31221, 32534, 12),
        Position(31222, 32534, 12),
    },
    attempts = {
        level = 200, 
        storage = 720073, 
    ...
    createTeleportPos = Position(31244, 32523, 12), 
    teleportToPosition = Position(31245, 32520, 12), 
