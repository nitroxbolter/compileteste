local config = {
    ...
    roulettePositions = { 
    Position(32531, 32198, 7),
    Position(32531, 32199, 7),
    Position(32531, 32200, 7),
    Position(32531, 32201, 7),
    Position(32531, 32202, 7),
    Position(32531, 32203, 7),
    Position(32531, 32204, 7),
    Position(32531, 32205, 7),
    Position(32531, 32206, 7),
    Position(32531, 32207, 7),
    Position(32531, 32208, 7),
    Position(32531, 32209, 7),
    }
}
