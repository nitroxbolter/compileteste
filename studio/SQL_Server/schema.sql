...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `skill_armorsmith` int unsigned NOT NULL DEFAULT 10,
  `skill_armorsmith_tries` bigint unsigned NOT NULL DEFAULT 0,
  `skill_weaponsmith` int unsigned NOT NULL DEFAULT 10,
  `skill_weaponsmith_tries` bigint unsigned NOT NULL DEFAULT 0,
  `skill_jewelsmith` int unsigned NOT NULL DEFAULT 10,
  `skill_jewelsmith_tries` bigint unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
