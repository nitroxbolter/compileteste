...
void IOMapSerialize::loadHouseItems(Map* map)
{
	...
	std::string location = "IOMapSerialize::loadHouseItems";
	std::ostringstream oss;
	oss << "Loaded house items in: " << (OTSYS_TIME() - start) / (1000.) << " s";
	console::print(CONSOLEMESSAGE_TYPE_STARTUP, oss.str(), true, location);
}
...
bool IOMapSerialize::saveHouseItems()
{
	...
	std::ostringstream oss;
	oss << "Saved house items in: " << (OTSYS_TIME() - start) / (1000.) << " s";
	console::print(CONSOLEMESSAGE_TYPE_INFO, oss.str(), true, "IOMapSerialize::saveHouseItems");
	return success;
}
