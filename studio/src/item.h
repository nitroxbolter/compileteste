...
class Item : virtual public Thing
{
	public:
		...
		std::vector<int32_t> getAttributeTypes(ItemTooltipAttributes_t id);
		...
		// Função pública para acessar rarityAttributes
		const std::multimap<ItemTooltipAttributes_t, std::pair<int32_t, IntegerVector>>& getRarityAttributes() const {
