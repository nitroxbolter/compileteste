...
class LuaScriptInterface
{
	...
	private:
		...
		//Rarity
		static int luaItemGetRarityLevel(lua_State* L);
		static int luaItemGetRarity(lua_State* L);
		static int luaItemGetRarityAttributes(lua_State* L);
		static int luaItemSetRarityLevel(lua_State* L);
		static int luaItemSetRandomRarity(lua_State* L);
		...
		static int32_t luaPlayerGetTotalIncrementCoins(lua_State* L);
		...
		static int luaSpellRenderBelow(lua_State* L);
