...
void Monster::dropLoot(Container* corpse, Creature* mostDamageCreature)
{
    if (corpse && lootDrop) {
        ...
        // Ejecuta el autoloot si existe el jugador que causó más daño
        ...
        // Recolecta todos los ítems del contenedor y subcontenedores
        containers = { corpse };  // Reutilizamos la variable containers aquí
