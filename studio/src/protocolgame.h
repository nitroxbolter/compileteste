...
class ProtocolGame final : public Protocol
{
	...
	private:
		...
		void sendMagicEffect(const Position& pos, uint16_t type, bool renderBelow = false);
		void sendAttachedEffect(const Position& pos, uint16_t effectId, bool renderBelow);
