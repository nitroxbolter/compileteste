...
{
	console::reportFileError(where, fileName, result.description());
	...
	console::reportError(where, "Line " + std::to_string(currentLine) + ": " + line);
	...
	errorPointer += '^';
	console::reportError(where, errorPointer);
}
